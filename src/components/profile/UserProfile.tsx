...
import { BadgeCheck, Settings, GripVertical, Award } from "lucide-react";
        ...
        <div className="h-full overflow-y-auto bg-black pb-20">
             ...
             <div className="flex flex-col items-center gap-4 mt-4 px-4">
                ...
                <div className="flex gap-2 mt-2 w-full max-w-xs">
                    <button className="flex-1 py-2 bg-pink-600 rounded-md font-semibold text-sm hover:bg-pink-700 transition-colors">Edit Profile</button>
             ...
             <div className="flex justify-around border-t border-gray-800 mt-8 sticky top-14 bg-black z-10">
                 <button className="flex-1 py-3 text-center border-b-2 border-white font-bold text-sm">Videos</button>
                 <button className="flex-1 py-3 text-center text-gray-500 hover:text-gray-300 text-sm">Liked</button>
                 <button className="flex-1 py-3 text-center text-gray-500 hover:text-gray-300 text-sm">Private</button>
             </div>
