...
import { Home, PlusSquare, User, Wallet, CalendarCheck, Gamepad2, ShoppingBag, Store } from "lucide-react";
  ...
  return (
    <div className="flex flex-col h-screen bg-black text-white relative">
      ...
      <main className="flex-1 overflow-hidden relative">
        ...
        {activeTab === "shop" && <MarketplaceView />}
      ...
      <nav className="absolute bottom-0 w-full bg-black/90 backdrop-blur-md border-t border-gray-800 flex justify-around py-2 z-30 pb-safe safe-area-bottom">
        ...
        <NavButton icon={<Store size={24} />} label="Shop" active={activeTab === "shop"} onClick={() => setActiveTab("shop")} />
