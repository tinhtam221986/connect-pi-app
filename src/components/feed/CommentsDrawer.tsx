        ...
        <div className="fixed inset-0 z-50 flex items-end justify-center sm:items-center bg-black/50 backdrop-blur-sm animate-in fade-in">
            ...
            <div
              className="relative w-full max-w-md flex flex-col h-[70vh] sm:h-[600px] shadow-2xl animate-in slide-in-from-bottom duration-300
                         bg-black/20 backdrop-blur-xl border-t border-white/20 sm:rounded-t-2xl sm:border"
            >
                {/* Header */}
                ...
                {/* Input Area */}
                <form onSubmit={handleSubmit} className="p-3 border-t border-white/10 bg-black/10 pb-safe">
                    <div className="flex gap-2 items-center bg-black/20 rounded-full px-4 py-2 border border-white/10 focus-within:border-white/50 transition-colors">
                        <input
                            type="text"
                            value={commentText}
